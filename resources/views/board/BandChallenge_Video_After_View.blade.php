...
<html>
  <head>
    ...
    <!--<link rel="stylesheet" href="/css/Select.css?var=">-->
    <!--<link rel="stylesheet" href="/css/After_View.css?var=">-->
    <style media="screen">
    ...
    */
    ...
    .videobox img[title="first"],.videobox img[title="second"]{
      width: 250px;
      height: 250px;
    }
    .font{
  ...
  <body>
    ...
    <div class="imgbox">
      <div class="videobox">
        ...
        <img title="second" src="/img/JSM.png" width="250" height="250">
      </div>
      <div class="font">
        <div class="point">
      ...
      <div class="user_comment">
        ...
        <p title="user_profile2"> 와 베이스에다가 신디 치니까 정말 재미있네요 ㅎㅎㅎ 다음에도 같이해요! </p>
        <img title="user_profile2" src="/img/JNH.png">

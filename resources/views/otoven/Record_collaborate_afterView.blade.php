  ...
  <h1>작곡 음원</h1>
    <div class="layer" name="layer" >
        <div style='border-radius: 5px;margin: 5px;padding: 5px;border: 1px solid black'>
          <input type='checkbox' checked name='participants' value=''/><br>
            <audio name='my_participant[]' controls preload='none'>
...
<div class="users">
  ...
  <p name="comment">함께 합주할 사람 구합니다! 오늘 작곡한 따끈따끈한 곡이에요!</p>
</div>
<div class="userstwo">
  <img src="/img/KHJ_Profile_Picture.png" alt="userimgtwo"></img>
  <p name="commenttwo">함께 합주를 할 수 있어서 즐거웠습니다! 감사합니다!</p>
</div>

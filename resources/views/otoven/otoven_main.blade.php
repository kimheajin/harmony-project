...
<head>
 ...
 <meta name="viewport" content="width=device-width, initial-scale=1.0"> 
        ...
        <link rel="stylesheet" type="text/css" href="/css/otoven_slide/demo.css?var=<?=filemtime('./css/otoven_slide/demo.css');?>" />
        <link rel="stylesheet" type="text/css" href="/css/otoven_slide/style.css?var=<?=filemtime('./css/otoven_slide/style.css');?>" />
...
<div id="total_wrap">
  ...
  <section> <!-- 중앙 컨텐츠 -->
     ...
     <article> <!-- 랭킹 1위 표시 article -->
        <span><a href="" style="text-decoration:none">Record작곡&합주랭킹</a></span>
        <span><a href="" style="text-decoration:none">Video작곡&합주랭킹</a></span><br><br>

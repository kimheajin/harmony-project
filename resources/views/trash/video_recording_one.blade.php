  ...
  <canvas class="visualizer"></canvas>
   ...
   <!--
    ...
    <div id="buttons">
        ...
        <button type="button" id="bandChallengeUpload">업로드</button>
    ...
    <div class="range-slider">
      <div class="range-slider">
        ...
        <p id="bpm">BPM</p>
          <input id="bpm_bar" class="range-slider__range" value="70"
          oninput="ShowSliderValue(this.value)" 
          onclick="metronomeStop(this.value)"  
          onmouseup="metronomeStart()" type="range" min="60" max="250" >
          <font  class="range-slider__value" size = 2 id = "slider_value_view">70</font>
    ...
    if( !empty($particis) ){
        ...
        foreach ($particis as $partici){
            $partici_src = '/uploads/bandChallenge/video/'.$partici;
